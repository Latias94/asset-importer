...
### Changed
- **Bundled Assimp updated**: Updated the `assimp` submodule to `v6.0.4` (`e0b52347c6e52de2827ec957a9ebf00ce3c54f79`).
- **Pregenerated bindings updated**: Regenerated `src/bindings_pregenerated.rs` for Assimp `v6.0.4`.
